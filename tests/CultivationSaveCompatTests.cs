...
public sealed class CultivationSaveCompatTests : IDisposable
{
    ...
    public void M2旧档_完全没有修仙_blob_读档照常且保留构造时的新档状态()
    {
        ...
        CultivationSystem cultivation = new(Roots, Realms, Speed, SpiritPower, "grade_false", null, "qi_refining", 1);
    ...
    public void M3_2新档_修为与层数跨进程不变()
    {
        ...
        CultivationSystem original = new(Roots, Realms, Speed, SpiritPower, "grade_heaven", null, "qi_refining", 1);
        ...
        CultivationSystem restored = new(Roots, Realms, Speed, SpiritPower, "grade_false", null, "qi_refining", 1);
    ...
    public void 读档之后写回去_版本升到三_修为与灵力都在()
    {
        ...
        var migrated = new CultivationSystem(Roots, Realms, Speed, SpiritPower, "grade_false", null, "qi_refining", 1);
        ...
        CultivationSystem reloaded = new(Roots, Realms, Speed, SpiritPower, "grade_false", null, "qi_refining", 1);
